      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'mileage_start',
              isInvalid: !!formik.errors?.mileage_start,
            }}
            name="mileage_start"
            error={formik.errors?.mileage_start}
            value={formik.values?.mileage_start}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('mileage_start', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'mileage_end',
              isInvalid: !!formik.errors?.mileage_end,
            }}
            name="mileage_end"
            error={formik.errors?.mileage_end}
            value={formik.values?.mileage_end}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('mileage_end', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
