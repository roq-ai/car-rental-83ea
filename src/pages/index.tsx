  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car sharing with Car Rental - your one-stop solution for managing profiles, booking and tracking vehicle usage. Empowering users and vehicle owners with comprehensive data and performance assessments."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car sharing with Car Rental - your one-stop solution for managing profiles, booking and tracking vehicle usage. Empowering users and vehicle owners with comprehensive data and performance assessments.`}
            </Text>
            <Box
